...
{
	int		  bFastSliceType;//fast slicetype
	int		  bFastSao;
	int		  bFastSubPixMe;//fast 1/2 1/4 pixel me
	int		  bFastIntra2;
	int		  bNoIntraRdo;//intra fastest mode, open it only if need
	int		  bFastChromaIntra;
	int		  bEnableFastRecursionSkip;
	int		  bEnableIntraFastCuSplit;
	int       bEnableGLFSfastSkip;
