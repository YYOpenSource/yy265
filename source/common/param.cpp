...
void x265_param_default(x265_param* param)
{
	...
	//yy tools 
	param->bEnableFastRecursionSkip = 0;
	param->bFastIntra2 = 0;
	param->bNoIntraRdo = 0;
	param->bEnableIntraFastCuSplit = 0;
	param->bFastChromaIntra = 0;
	param->bEnableGLFSfastSkip = 0;
	param->bFastSubPixMe = 0;
	param->bFastSao = 0;
	param->bFastSliceType = 0;
}
...
int x265_param_default_preset(x265_param* param, const char* preset, const char* tune)
{
    ...
    if (preset)
    {
		...
		else if (!strcmp(preset, "yyfaster"))
		{
			param->lookaheadDepth = 15;
			param->bFrameAdaptive = 0;
			param->bEnableEarlySkip = 1;
			...
			param->bEnableFastRecursionSkip = 1;
			param->bFastIntra2 = 1;
			param->bNoIntraRdo = 0;//暂时关闭
			param->bEnableIntraFastCuSplit = 1;
			param->bFastChromaIntra = 1;
			param->bEnableGLFSfastSkip = 1;
			param->bFastSubPixMe = 1;
			param->bFastSao = 1;
			param->bFastSliceType = 1;//某些序列与cu skip耦合
