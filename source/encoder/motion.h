...
public:
	...
	void setSourcePU(pixel *fencY, intptr_t stride, intptr_t offset, int pwidth, int pheight, const int searchMethod, const int subpelRefine, const int bFastSubPixMe, const int bfastLowers);
	void setSourcePU(const Yuv& srcFencYuv, int ctuAddr, int cuPartIdx, int puPartIdx, int pwidth, int pheight, const int searchMethod, const int subpelRefine, const int bFastSubPixMe, const int bfastLowers ,bool bChroma);
